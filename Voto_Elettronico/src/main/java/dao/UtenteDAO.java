...
public class UtenteDAO implements GenericDAO<Utente>{
		...
		try {
			...
			while(rs.next()) {
				if(rs.getString("ruolo").equalsIgnoreCase("Elettore")) {
					u=new Elettore(rs.getString("nome"), rs.getString("cognome"), rs.getString("cod_fisc"));
				}else {
					u=new Scrutinatore(rs.getString("nome"), rs.getString("cognome"), rs.getString("cod_fisc"));
				}
			}
	...
	public List<Utente> getAll() {
		...
		try {
			...
			while(rs.next()) {
				if(rs.getString("ruolo").equalsIgnoreCase("Elettore")) {
					l.add(new Elettore(rs.getString("nome"), rs.getString("cognome"), rs.getString("cod_fisc")));
				}else {
					l.add(new Scrutinatore(rs.getString("nome"), rs.getString("cognome"), rs.getString("cod_fisc")));
				}
